...
function createModal(massive) {
    ...
    modalWrapper.innerHTML = `
        <div class="image__container">
            <img class="product-card__image" src='${id.img.src}'>
            <img class="product-card__outline" src="images/product-card/Ellipse%206.png">
        </div>
        <div class="main-container">
            <h1 class="product-card__title">${id.title}</h1>
            <p class="product-card__description">${id.subtitle}</p>
            <div class="product-card__adds">
            <p class="product-card__add">${id.description}</p>
